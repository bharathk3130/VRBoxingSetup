...
{
    public class MaximizeAndPlay : EditorWindow
    {
         ...
         * 5. Then in the shortcuts window search for "Clear Console" and set the shortcut Ctrl + Shift + C to it
        ...
        [MenuItem("Tools/MyShortcuts/Maximize Game View and Play")]
        ...
        [MenuItem("Tools/MyShortcuts/Minimize Game View and Pause")]
